...
slack_oauth_access_token = get_environment_variable("SLACK_OAUTH_ACCESS_TOKEN")
...
def send_message_to_channel(message="ping", attachments=None, channel_id=DEFAULT_SLACK_CHANNEL_ID,
                            icon=DEFAULT_SLACK_ICON, display_name=None):
    result = slack_client.api_call(method="chat.postMessage",
                                   text=message,
...
def is_valid_request(request):
    ...
    validation_hash_key = get_environment_variable("SLACK_SIGNING_SECRET")
